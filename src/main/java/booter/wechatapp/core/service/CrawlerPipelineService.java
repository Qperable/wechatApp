...
import booter.wechatapp.core.enums.UrlEnum;
import booter.wechatapp.core.util.ContextParseUtils;
...
public class CrawlerPipelineService implements Pipeline {
    ...
    private void crawMiGuNewTopSong(ResultItems resultItems) {
        ...
        FileHandleUtils.fileDownloadByMap(songMap, "");// FileHandleUtils.assembleTextName(url));
    }
